...
const DayBtn = ({ day, selected, inRange, onClick }: DayBtnProps) => {
...
const NeoCalendar = ({ startDate, endDate, onStartChange, onEndChange, onClose }: NeoCalendarProps) => {
  ...
  const quickSelect = (daysAgo: number) => {
    const end = new Date();
