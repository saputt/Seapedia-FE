...
const RoleIcon = ({ role }: { role: RoleName }) => {
  const className = "w-10 h-10 text-brand-deep";
  switch (role) {
    case "SELLER":
      return (
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50">
      <div className="card !p-8 mx-4 flex flex-col items-center gap-4 min-w-[280px]">
        <div className="w-16 h-16 rounded-full bg-brand-subtle/30 flex items-center justify-center">
          <RoleIcon role={role} />
        </div>
