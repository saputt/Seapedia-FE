        ...
        {!isLoading && !isError && product && (
          <div className="mt-12">
            <h2 className="text-xl font-bold text-text-primary mb-6">
               Ulasan Pembeli{reviews.length > 0 ? ` (${(product as any).reviewCount || reviews.length})` : ""}
            </h2>
            {reviews.length === 0 ? (
              ...
              <div className="space-y-4">
                {reviews.map((review: { id: string; buyer?: { username: string }; rating: number; comment: string; createdAt: string }) => (
