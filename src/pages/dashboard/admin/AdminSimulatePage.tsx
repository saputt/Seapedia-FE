...
const AdminSimulatePage: React.FC = () => {
  ...
  const totalSkipped = (simStatus as any)?.data?.totalDaysSkipped ?? 0;

  const handleSimulate = async () => {
    const daysToSkip = parseInt(days, 10) || 1;
    setResult(null);
    try {
      const res = await mutation.mutateAsync(daysToSkip as any);
            ...
            <div className="space-y-3">
              ...
              <div className="border-t border-border pt-3">
                ...
                <p className="text-sm font-semibold text-brand-deep">
                  {new Date((simStatus as any).data.simulatedDate).toLocaleDateString("id-ID", {
