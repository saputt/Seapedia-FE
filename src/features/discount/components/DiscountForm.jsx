...
/**
 * Form untuk membuat diskon baru.
 * Diekstrak dari AdminDiscountsPage.
 *
 * @param {Object} props
 * @param {Function} props.onSubmit - Handler submit (data) => void
 * @param {boolean} props.isPending - Status loading submit
 * @param {Function} props.onCancel - Handler batal
 */
const DiscountForm = ({ onSubmit, isPending, onCancel }) => {
