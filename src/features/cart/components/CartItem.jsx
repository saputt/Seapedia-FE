...
/**
 * CartItem component untuk menampilkan satu item di keranjang.
 * Menangani layout mobile dan desktop secara internal.
 *
 * @param {Object} props
 * @param {Object} props.item - Data item keranjang
 * @param {boolean} props.busy - Status loading untuk item ini
 * @param {Function} props.onUpdateQty - Handler update quantity (productId, newQty)
 * @param {Function} props.onRemove - Handler hapus item (productId)
 */
const CartItem = ({ item, busy, onUpdateQty, onRemove }) => {
